...
- **Branch Naming**: All branches use the `[Jira ID]-[service-short-name]-feature/[randomName]` prefix. See [Branching Workflow — Naming Convention](BRANCHING_WORKFLOW.md#branch-naming-convention).
...
- **Creating PRs**: `gh pr create --title "ODY2-123: Add feature" --body-file .github/PULL_REQUEST_TEMPLATE.md`
